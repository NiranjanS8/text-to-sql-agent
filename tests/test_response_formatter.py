...
def test_build_final_answer_for_success_empty_and_error_states() -> None:
    success = QueryExecutionResult(question="Show students", sql="SELECT * FROM students;", row_count=2)
    ...
    assert build_final_answer(success) == "Found 2 matching rows for: Show students"
